...
The Bureau of Transportation Statistics (BTS) classes a flight as delayed if it is later than 15 minutes (or more) from its scheduled time.

#### Domain knowledge and the business context

Briefly describe the business/organisation and where your analysis fits within its aims/activity.

One of the three major airports in the New York metropolitan area, Newark Airport (or Newark Liberty International Airport) was the sixth busiest international airport in the United States in 2017. It only has three runways and one helipad.
...
An American study estimated that delayed flights has cost the US economy a total of nearly 33 billion dollars (REF = Ball et al).

Total of delayed flights due to extreme weather may appear small at first glance, however results in delay of other types... (((check BTS website on delays)))
